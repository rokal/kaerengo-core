...
// @CollectionTable(name = "aptitude_formation", joinColumns = @JoinColumn(name
/// = "formationId") )
...
// @CollectionTable(name = "niveau_formation", joinColumns = @JoinColumn(name =
/// "formationId") )
// @Enumerated(EnumType.STRING)
// @Column(name = "niveau")
...
// @CollectionTable(name = "domaine_formation", joinColumns = @JoinColumn(name =
/// "formationId") )
// @Enumerated(EnumType.STRING)
// @Column(name = "domaine")
