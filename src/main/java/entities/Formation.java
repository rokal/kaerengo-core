...
public class Formation implements Serializable {
	...
	@CollectionTable(name = "aptitude_formation", joinColumns = @JoinColumn(name = "formationId") )
	@Enumerated(EnumType.STRING)
	@Column(name = "aptitude")
	private Set<Aptitude> aptitudes;

	@ElementCollection(targetClass = Niveau.class)
	@CollectionTable(name = "niveau_formation", joinColumns = @JoinColumn(name = "formationId") )
	@Enumerated(EnumType.STRING)
	@Column(name = "niveau")
	private Set<Niveau> niveau;

	@ElementCollection(targetClass = Domaine.class)
	@CollectionTable(name = "domaine_formation", joinColumns = @JoinColumn(name = "formationId") )
	@Enumerated(EnumType.STRING)
	@Column(name = "domaine")
